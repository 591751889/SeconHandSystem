...
<body>
	<div class="container">
		<div class="public-nav">您当前的位置：<a href="">修改商品信息</a>></div>
		<div class="public-content" style="margin-top: 0">
			<div class="public-content-cont">
			<form action="product_updateProduct.action" method="post" enctype="multipart/form-data" style="margin:0 auto;width:50%" onsubmit="return checkForm(this);">
				<s:actionmessage style="font-size:18px;color:#000"/>
				<input type="hidden" id="ppid"  name="id"/>
				<input type="hidden" id="uuid"  name="creatorId"/>
