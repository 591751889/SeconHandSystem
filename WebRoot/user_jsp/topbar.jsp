...
<input type="hidden" value="<%=uName %>" id="uuname" />
   ...
   <div class="bar_right" style="position:relative;margin-right:50px" id="info">
        <div id="commonTopbar_login">
           ...
           <a href="/SeconHandSystem/admin_jsp/admin_login.jsp">进入后台</a> 
        </div>   
        <div class="shopping_cart" id="commonTopbar_cart">
           <a href="shop_cart.jsp" target="_blank">购物车
           </a>
        </div>   
        <div class="post_order" id="commonTopbar_post">
...
<script type="text/javascript">
	...
	if(uuname!=null&&uuname!=""){
		...
		$("#commonTopbar_my58menu").hide();
		$("#commonTopbar_cart").hide();
		$("#commonTopbar_post").hide();
	}
