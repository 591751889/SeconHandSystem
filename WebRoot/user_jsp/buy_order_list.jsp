...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="shopping1">
	...
	<tr>
	  ...
	  <s:if test="#buy.status==0">
	  	<td class="goods order_item_select order_status"><a href="evaluation.jsp?creatorName=${ creatorName }&id=${ id }&uid=<s:property value="#buy.user.uid"/>">为本次购物打分吧！</a></td>
	  </s:if>
	  <s:else>
...
<script>
	var creatorName='<s:property value="#buy.creatorName"/>';
	var id='<s:property value="#buy.id"/>';
</script>
</html>