...
<script type="text/javascript">
    ...
    '<td class="order_describe"><a href="@url" style="color:#16a085" title="修改">@title</a><br />'+
    '@prodesc</td>'+
    ...
    '<td class="goods order_item_select"><a style="color:#5cbdaa" href=""javascript:opener.location.reload()" onclick="javascript:deleteRow(\'@id\');">删除</a></td>'+
    '</tr>';
	var currPage;
	var totalPage;
		...
		$.ajax({
			   ...
			   success: function(result){
			    ...
			    for(var i=0;i<len;i++){
			    	...
			    	temp=temp.replace("@url","product_update.jsp?pid="+data[i].id+"&uid="+data[i].creatorId);
