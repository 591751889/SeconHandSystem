...
public class UserService implements IUserService {
	...
	public void addEvaluation(Evaluation evaluation) {
		this.iUserDao.addEvaluation(evaluation);
	}

	@Override
	public int searchEvaluation(String username) {
		return this.iUserDao.searchEvaluation(username);
	}

	@Override
	public void searchAndUpdateOrederById(String id) {
		this.iUserDao.searchAndUpdateOrederById(id);
	}

	@Override
	public List<Integer> getEvaluationStar(String username) {
		return this.iUserDao.getEvaluationStar(username);
	}

	@Override
	public void updateUserPrice(User user) {
		this.iUserDao.updateUserPrice(user);
	}
