...
public interface IUserDao {
    ...
    /**
     * <p>Description: 根据订单号查询订单并修改状态</p>
     * @param ids
     */
    void searchAndUpdateOrederById(String id);
    /**
	 ...
	 * @return
	 */
	int searchEvaluation(String username);
	/**
	 *  查找出每次评价
	 */
	List<Integer> getEvaluationStar(String username);
