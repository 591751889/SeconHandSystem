...
public class UserDao extends HibernateDaoSupport implements IUserDao {
	...
	public List<Product> searchProductList(Map<Object, String> map) {
		...
		List<Product> list = this.getHibernateTemplate().findByCriteria(dc, Integer.parseInt(map.get("begin")),
	...
	public List<Comment> getCommentList(String id, Map<Object, String> map) {
		...
		List<Comment> list = this.getHibernateTemplate().findByCriteria(dc, Integer.parseInt(map.get("begin")),
				Integer.parseInt(map.get("pageSize")));
		return list;
	}
	...
	public List<MyCart> getMyCartList(Map<Object, String> map) {
		...
		dc.addOrder(Order.desc("createTime"));
		dc.setResultTransformer(dc.DISTINCT_ROOT_ENTITY);
		List<MyCart> list = this.getHibernateTemplate().findByCriteria(dc, Integer.parseInt(map.get("begin")),
				Integer.parseInt(map.get("pageSize")));
		return list;
	}
	...
	public List<model.Order> getMyOrderList(Map<Object, String> map) {
		...
		dc.addOrder(Order.desc("createTime"));
		dc.setResultTransformer(dc.DISTINCT_ROOT_ENTITY);
		List<model.Order> list = this.getHibernateTemplate().findByCriteria(dc, Integer.parseInt(map.get("begin")),
				Integer.parseInt(map.get("pageSize")));
		return list;
	}
	...
	public List<Product> getMyProductList(Map<Object, String> map) {
		...
		for (int i = 0; i < list.size(); i++) {
			list.get(i).setCreatorId(Integer.parseInt(map.get("userId")));
		}
		return list;
	}
	...
	public List<Comment> getCommentList(Map<Object, String> map) {
		...
		dc.setResultTransformer(dc.DISTINCT_ROOT_ENTITY);
		List<model.Comment> list = this.getHibernateTemplate().findByCriteria(dc, Integer.parseInt(map.get("begin")),
				Integer.parseInt(map.get("pageSize")));
		return list;
	}
	...
	public List<UserAndAdmin> getMessageList(Map<Object, String> map) {
		...
		List<model.UserAndAdmin> list = this.getHibernateTemplate().findByCriteria(dc,
				Integer.parseInt(map.get("begin")), Integer.parseInt(map.get("pageSize")));
		return list;
	}
	...
	public void addEvaluation(Evaluation evaluation) {
		this.getHibernateTemplate().saveOrUpdate(evaluation);
	}

	@Override
	public int searchEvaluation(String username) {
		StringBuffer sb = new StringBuffer();
		String hql = "select count(*) from Evaluation where username='" + username + "'";
	...
	@Override
	public void searchAndUpdateOrederById(String id) {
		String hql = "update Order set status =1 where id ='" + id + "'";
	...
	@Override
	public List<Integer> getEvaluationStar(String username) {

		String hql = "select star from Evaluation where username ='" + username + "'";
		List<Integer> star = this.getHibernateTemplate().find(hql);
		return star;
	}
